...
export const CommonForm = (props: CommonFormProps) => {
    ...
    let [initialValues, setInitialValues] = useState<any>(props.data || {})
    const onSubmit = (formik: any) => { props.onAction('SAVE', formik.values); formik.resetForm() }
        ...
        return (
            <div className="flex align-items-center justify-content-end">
                ...
                <Button type="submit" icon="pi pi-check" label={props.submitButtonLabel} className="ml-2 p-button-text primary-btn"
                    onClick={() => { onSubmit(formik); }} disabled={!(formik.isValid && formik.dirty)} />
            </div>
        )
    }
