...
export class AddcrversionComponent {
  ...
  constructor(private fb: FormBuilder,  private localStorageService: LocalStorageService,private utilsService:UtilsService,private commentsService: CommentsService,) {
  ...
  closePopUp() {
    this.closeNewVersionPopUp.emit(false);
  }
